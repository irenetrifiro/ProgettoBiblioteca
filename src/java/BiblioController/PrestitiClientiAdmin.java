...
public class PrestitiClientiAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Prestito> prestiti = Model.getPrestitiAdmin(catalogo);
         
        request.setAttribute("prestiti", prestiti);
        RequestDispatcher rd = ctx.getRequestDispatcher("/prestitiClienti.jsp"); //vai alla pagina Prestiti Clienti
